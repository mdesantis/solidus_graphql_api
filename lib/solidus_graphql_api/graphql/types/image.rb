...
module Spree::GraphQL::Types::Image
  ...
  # @param max_width [Types::Int] (nil) Image width in pixels between 1 and 5760.
  # @param max_height [Types::Int] (nil) Image height in pixels between 1 and 5760.
  # @param crop [Types::CropRegion] (nil) Crops the image according to the specified region.
  # @param scale [Types::Int] (1) Image size multiplier for high-resolution retina displays. Must be between 1 and 3.
  # @param preferred_content_type [Types::ImageContentType] (nil) Best effort conversion of image into content type (SVG -> PNG, Anything -> JGP, Anything -> WEBP are supported).
  # @return [Types::URL!]
